...
df <- data.frame(wells) %>%
  mutate(switch = as.factor(switch),
         arsenic = as.factor(arsenic),
         dist = as.factor(dist),
         assoc = as.factor(assoc),
         educ = as.factor(educ),
         educ4 = as.factor(educ4),
         use = as.factor(use),
         status_perceived = as.factor(status_perceived),
         well_shift = as.factor(well_shift))
# Community Association
barplot(prop.table(table(assoc)), main = "Community Association", 
        xlab = "0 = No, 1 = Yes", ylab = "Proportion", ylim = c(0,0.6))
ggplot(data = df, mapping = aes(x = assoc, fill = switch)) +
  geom_bar(position = "fill") + 
  labs (x = "Community Association*", y = "Percentage", 
        caption = "*0 = No, 1 = Yes")
# Education (Recoded)
barplot(prop.table(table(educ4)), main = "Education (Recoded)", 
        xlab = "0 = 0,  1 = 1-8,  2 = 9-12,  3 = 12+ Years of Education", 
        ylab = "Proportion", ylim = c(0,0.4))
ggplot(data = df, mapping = aes(x = educ4, fill = switch)) +
  geom_bar(position = "fill") + 
  labs (x = "Years of Education*", y = "Percentage", 
        caption = "*0 = 0,  1 = 1-8,  2 = 9-12,  3 = 12+")
# Use
barplot(prop.table(table(use)), main = "Well Use", 
        xlab = "0 = Neither,  1 = Unfrequently,  2 = Drinking,  3 = Cooking", 
        ylab = "Proportion", ylim = c(0,0.6))
ggplot(data = df, mapping = aes(x = use, fill = switch)) +
  geom_bar(position = "fill") + 
  labs (x = "Well Use*", y = "Percentage", 
        caption = 
          "*0 = Neither,  1 = Unfrequently,  2 = Drinking,  3 = Cooking")
# Perceived Status
barplot(prop.table(table(status_perceived)), main = "Perceived Status", 
        xlab = "0 = Unsafe,  1 = Safe,  2 = Don't Know", ylab = "Proportion", 
        ylim = c(0,0.9))
ggplot(data = df, mapping = aes(x = status_perceived, fill = switch)) +
  geom_bar(position = "fill") + 
  labs (x = "Perceived Status*", y = "Percentage", 
        caption = "*0 = Unsafe,  1 = Safe,  2 = Don't Know")

# Shift
barplot(prop.table(table(well_shift)), main = "Well Shift (Last 3 Years)", 
        xlab = "0 = No,  1 = Yes", ylab = "Proportion", ylim = c(0,1))
ggplot(data = df, mapping = aes(x = well_shift, fill = switch)) +
  geom_bar(position = "fill") + 
  labs (x = "Well Shift (Last 3 Years)*", y = "Percentage", 
        caption = "*0 = No,  1 = Yes")

### Response Variable
barplot(prop.table(table(switch)), main = "Well Switch (Response)", 
        xlab = "0 = No,  1 = Yes", ylab = "Proportion", ylim = c(0,0.6))
```
