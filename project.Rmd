...
full <- stan_glm(switch ~ dist100 + arsenic + educ4 + assoc + use + status_perceived + well_shift + arsenic*status_perceived + arsenic*dist100 + educ4*use + dist100*use + dist100*status_perceived + well_shift*dist100 + status_perceived*use + status_perceived*educ4, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

no_dist_m <- stan_glm(switch ~ arsenic + educ4 + assoc + use + status_perceived + well_shift + arsenic*status_perceived + educ4*use + status_perceived*use + status_perceived*educ4, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

no_arsenic_m <- stan_glm(switch ~ dist100 + educ4 + assoc + use + status_perceived + well_shift + educ4*use + dist100*use + dist100*status_perceived + well_shift*dist100 + status_perceived*use + status_perceived*educ4, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

no_educ_m <- full <- stan_glm(switch ~ dist100 + arsenic + assoc + use + status_perceived + well_shift + arsenic*status_perceived + arsenic*dist100 + dist100*use + dist100*status_perceived + well_shift*dist100 + status_perceived*use, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

no_assoc_m <- stan_glm(switch ~ dist100 + arsenic + educ4 + use + status_perceived + well_shift + arsenic*status_perceived + arsenic*dist100 + educ4*use + dist100*use + dist100*status_perceived + well_shift*dist100 + status_perceived*use + status_perceived*educ4, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

no_use_m <- stan_glm(switch ~ dist100 + arsenic + educ4 + assoc + status_perceived + well_shift + arsenic*status_perceived + arsenic*dist100 + dist100*status_perceived + well_shift*dist100 + status_perceived*educ4, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

no_status_perceived_m <- stan_glm(switch ~ dist100 + arsenic + educ4 + assoc + use + well_shift + arsenic*dist100 + educ4*use + dist100*use + well_shift*dist100, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

no_well_shift_m <- stan_glm(switch ~ dist100 + arsenic + educ4 + assoc + use + status_perceived + arsenic*status_perceived + arsenic*dist100 + educ4*use + dist100*use + dist100*status_perceived + status_perceived*use + status_perceived*educ4, data = wells,
                 family = binomial(link = "logit"), 
                 prior = t, prior_intercept = t,
                 seed = seed,
                 refresh = 0)

print(no_dist_m$stanfit)
print(no_arsenic_m$stanfit)
print(no_educ_m$stanfit)
print(no_use_m$stanfit)
print(no_assoc_m$stanfit)
print(no_status_perceived_m$stanfit)
print(no_well_shift_m$stanfit)
```
