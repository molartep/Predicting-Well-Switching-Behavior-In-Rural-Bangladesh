...
```{r EDA, echo=FALSE, cache=TRUE, fig.height=3, fig.width=7}
...
```{r}
round(coef(no_educ_interac), 3)
round(posterior_interval(no_educ_interac, prob = 0.95), 3)
```
