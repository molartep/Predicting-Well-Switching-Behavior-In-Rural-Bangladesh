...
contamination by microbes, hence the desire to use water from deep wells.)
In the area shown in Figure 5.7, a research team from the United States and
...
In this project, we attempted to determine the relationship (if any) between arsenic concentrations and well usage.
...
full <- read.csv ("C:\\Users\\naga2\\Documents\\Duke Spring '21\\STA 360L\\fulldata1.csv")
# all1 <- read.csv ("C:\\Users\\naga2\\Documents\\Duke Spring '21\\STA 360L\\All.csv")
